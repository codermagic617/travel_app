...
const Camp = () => {
  return (
    <section className=" 2xl:max-container relative flex flex-col py-10 lg:mb-10 lg:py-20 xl:mb-20">
      <div className="hide-scrollbar flex lg:h-[400px] xl:h-[640px] over-x-auto justify-start gap-8 items-start w-full h-[340px] ">
        <CampSite backgroundImage="bg-bg-img-1" title="Putuk Turano Camp" subtitle="Prigen, Pasuruan" peopleJoined="50+ Joined" />
        <CampSite backgroundImage="bg-bg-img-2" title="Somewhere in the wilderness" subtitle="Prigen, Pasuruan" peopleJoined="80+ Joined" />
      </div>
